...
export default function App() {
  ...
  // Undo stack — ref so it never triggers re-renders or persists to localStorage
  ...
  // setS — snapshots current state to undo stack before every change (max 30)
  const setS = fn => setS_(s => {
